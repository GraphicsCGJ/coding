...
int main(void) {
    ...
    if (cross1 == 0 && cross2 == 0) {
        ...
        if (d1 < 0 || d2 < 0) {
            ...
            cout << 1 << '\n';
            if (d1 == 0) {
                if (((v3 - v1).x == 0 && (v3 - v1).y == 0 && (v4 - v1).dot(v2 - v1) < 0) ||
                        ((v4 - v1).x == 0 && (v4 - v1).y == 0 && (v3 - v1).dot(v2 - v1) < 0)) {
                    cout << v1.x << ' ' << v1.y << '\n';
                }
            }
            else if (d2 == 0) {
                if (((v3 - v2).x == 0 && (v3 - v2).y == 0 && (v4 - v2).dot(v1 - v2) < 0) ||
                        ((v4 - v2).x == 0 && (v4 - v2).y == 0 && (v3 - v2).dot(v1 - v2) < 0)) {
                    cout << v2.x << ' ' << v2.y << '\n';
                }
            }
        }
